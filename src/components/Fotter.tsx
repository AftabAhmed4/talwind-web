...
const Footer = () => {
  return (
    <div>
      <footer className="text-gray-700 bg-gray-900 body-font">
        <div className="container px-6 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
            <a className="flex title-font font-semibold text-white items-center md:justify-start justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-10 h-10 text-white p-2 bg-indigo-500 rounded-full" viewBox="0 0 24 24">
                <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path>
              </svg>
              <span className="ml-3 text-xl font-extrabold text-indigo-500">Tailblocks</span>
            </a>
          ...
          <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4 mb-6">
              ...
              <nav className="list-none mb-10">
                <li>
                  <a className="text-gray-400 hover:text-white">Resource 1</a>
                </li>
                <li>
                  <a className="text-gray-400 hover:text-white">Resource 2</a>
                </li>
                <li>
                  <a className="text-gray-400 hover:text-white">Resource 3</a>
                </li>
                <li>
                  <a className="text-gray-400 hover:text-white">Resource 4</a>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4 mb-6">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4 mb-6">
              <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3">FOLLOW</h2>
              <nav className="list-none mb-10">
                <li>
        ...
        <div className="bg-gray-800">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-400 text-sm text-center sm:text-left">© 2025 Web
